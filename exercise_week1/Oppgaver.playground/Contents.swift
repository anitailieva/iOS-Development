...
*/
    //let word = "Swift er fett!"

    //print(word)

    var abc = "Swift er fett!"
    abc = "new"
    print(abc)
...
*/
    ...
    dictionary["English"] = 9
    dictionary["Norwegian"] = 11
    dictionary["German"] = 24
    dictionary["Russian"] = 1
    dictionary["Italian"] = 15
...
//:    My water bottle-rocket : 1 launch        // merk dropp genitivs-s når det er kun 1 launch
    let rock = rockets.filter{($0 is String)}
    for i in 0..<rock.count{
    var rocket : String = rock[i] as! String
